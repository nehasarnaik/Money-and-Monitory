              ...
              <div className="card bg-violet text-white">
                <div className="card-body">
                  ...
                  <p className="card-text">
                    ...
                    to the nearest dollar, and the extra cents are automatically
                    transferred straight into your savings.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="card bg-violet text-white">
                <div className="card-body ">
                  ...
                  <p className="card-text">
                    ...
                    needed and also lock savings account according to you needs.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-md-6">
              <div className="card bg-violet text-white">
                <div className="card-body">
                  ...
                  <p className="card-text">
                    Build your savings habits without even having to think about
                    it. Each rounded-up transaction contributes to your savings,
                    helping you achieve your financial goals over time.
                  </p>
                </div>
              </div>
            </div>
