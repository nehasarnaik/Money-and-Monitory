    ...
    <>
      ...
      <div class="position-left text-left left-half text-white">
        <div class="col-md-10">
          ...
          <p class="lead font-weight-normal padding">
            Welcome to Coin Stash, where smart banking meets effortless saving!
            Discover our innovative 'RoundUp Savings' feature – every
            transaction you make gets rounded up, and the extra change goes
            straight into your savings account. It's a simple, automatic way to
            cultivate the habit of saving while you manage your finances. Start
            rounding up and watch your savings grow. Join us on the journey to
